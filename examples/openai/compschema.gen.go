...
func DecodeAnnotation(data []byte) (Annotation, error) {
	...
	return nil, fmt.Errorf("no matching variant for Annotation")
}
...
//		// circle is populated
//	}
func AnnotationAs[T any](v Annotation, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeCodeInterpreterToolOutput(data []byte) (CodeInterpreterToolOutput, error) {
	...
	return nil, fmt.Errorf("no matching variant for CodeInterpreterToolOutput")
}
...
//		// circle is populated
//	}
func CodeInterpreterToolOutputAs[T any](v CodeInterpreterToolOutput, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeComputerAction(data []byte) (ComputerAction, error) {
	...
	return nil, fmt.Errorf("no matching variant for ComputerAction")
}
...
//		// circle is populated
//	}
func ComputerActionAs[T any](v ComputerAction, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeTextResponseFormatConfiguration(data []byte) (TextResponseFormatConfiguration, error) {
	...
	return nil, fmt.Errorf("no matching variant for TextResponseFormatConfiguration")
}
...
//		// circle is populated
//	}
func TextResponseFormatConfigurationAs[T any](v TextResponseFormatConfiguration, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeTool(data []byte) (Tool, error) {
	...
	return nil, fmt.Errorf("no matching variant for Tool")
}
...
//		// circle is populated
//	}
func ToolAs[T any](v Tool, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
//		// circle is populated
//	}
func FiltersAs[T any](v Filters, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeInputContent(data []byte) (InputContent, error) {
	...
	return nil, fmt.Errorf("no matching variant for InputContent")
}
...
//		// circle is populated
//	}
func InputContentAs[T any](v InputContent, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
//		// circle is populated
//	}
func InputItemAs[T any](v InputItem, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeOutputContent(data []byte) (OutputContent, error) {
	...
	return nil, fmt.Errorf("no matching variant for OutputContent")
}
...
//		// circle is populated
//	}
func OutputContentAs[T any](v OutputContent, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
//		// circle is populated
//	}
func ItemResourceAs[T any](v ItemResource, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
//		// circle is populated
//	}
func OutputItemAs[T any](v OutputItem, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
...
func DecodeResponseStreamEvent(data []byte) (ResponseStreamEvent, error) {
	...
	return nil, fmt.Errorf("no matching variant for ResponseStreamEvent")
}
...
//		// circle is populated
//	}
func ResponseStreamEventAs[T any](v ResponseStreamEvent, target *T) bool {
	t, ok := any(v).(*T)
	if ok {
		*target = *t
	}
